...
/** Bounds JSON/API request bodies even when the request is sent without Content-Length. */
@Component
@Order(2)
public final class RequestBodySizeLimitFilter extends OncePerRequestFilter {
    ...
    private void reject(HttpServletResponse response) throws IOException {
        ...
        json.writeValue(response.getOutputStream(),
            ApiResponse.failure(41301, "PAYLOAD_TOO_LARGE", "Request body is too large"));
    }
