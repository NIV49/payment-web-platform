...
public interface UserAdministrationPort {
    ...
    long createUser(long tenantId, long operatorMembershipId, IdentityModels.UserCreateCommand command);
    void updateUser(long tenantId, long operatorMembershipId, long userId,
