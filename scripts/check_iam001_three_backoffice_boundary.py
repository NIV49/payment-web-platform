...
OWNED_PATHS = (
    ...
    "frontend/admin/packages/effects/backoffice-runtime",
...
PROCESS_COMMANDS = (
    ...
    Command("frontend/admin", (
        "pnpm",
        "--filter", "@payment/backoffice-runtime",
        "--filter", "@payment/platform-admin",
        "--filter", "@payment/merchant-admin",
        "--filter", "@payment/agent-admin",
        "--parallel", "run", "typecheck",
    )),
    Command("frontend/admin", ("pnpm", "test:unit")),
    Command("frontend/admin", ("pnpm", "test:production-safety")),
    Command("frontend/admin", ("pnpm", "run", "build:backoffices")),
